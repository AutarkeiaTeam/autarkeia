    ...
    <div className="min-h-screen bg-[#f5f7fa] flex items-center justify-center px-4">
      <div className="bg-white border border-[#d4dce8] rounded-2xl p-8 w-full max-w-md">
        ...
        <button
          ...
          disabled={isLoading}
          className="mb-3 flex w-full items-center justify-center gap-2 rounded-lg border border-[#d4dce8] px-4 py-2.5 text-center text-sm text-[#3d5166] hover:bg-[#f5f7fa] disabled:opacity-60"
        >
