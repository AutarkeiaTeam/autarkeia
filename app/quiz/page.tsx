...
export default function QuizSelectorPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <motion.div className="flex-1 bg-white py-16 sm:py-24">
        <motion.div className="mx-auto max-w-4xl px-4 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <motion.div className="flex items-center gap-2 text-[#009b70] font-medium">
                <span>{t("quiz.start")}</span>
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
              </motion.div>
              <motion.div className="absolute bottom-0 left-0 right-0 h-1 rounded-b-2xl bg-[#009b70] opacity-0 transition-opacity group-hover:opacity-100" />
            </Link>
            ...
            >
              ...
              <motion.div className="flex items-center gap-2 text-[#5c4a2a] font-medium">
                <span>{t("quiz.start")}</span>
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
              </motion.div>
              <motion.div className="absolute bottom-0 left-0 right-0 h-1 rounded-b-2xl bg-[#5c4a2a] opacity-0 transition-opacity group-hover:opacity-100" />
            </Link>
          </div>
