...
const CATEGORY_KEYWORDS: Record<MarketplaceCategory, string[]> = {
  ...
  Lighting: ["flashlight", "headlamp", "lantern", "torch", "light", "candle", "glow stick", "lumen"],
  Navigation: ["navigation", "compass", "map", "gps", "atlas", "protractor", "topographic"],
  ...
  "Pet Preparedness": ["pet", "dog", "cat", "leash", "carrier", "animal"],
  "Children & Family": ["baby", "infant", "child", "diaper", "formula", "family"],
  "Documents & Finance": ["document", "fireproof", "safe", "faraday", "cash", "finance", "passport"],
  Clothing: ["clothing", "jacket", "boots", "apparel", "wear", "fleece", "rainwear", "gloves"],
  "Bartering & Currency": [
    "silver",
    "gold",
...
const FEED_PATH_RULES: { test: RegExp; category: MarketplaceCategory }[] = [
  ...
  { test: /flashlight|torch|lantern|headlamp/i, category: "Lighting" },
